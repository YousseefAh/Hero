...
export const metadata = {
  title: "تواصل معنا — BePrime",
  description: "تواصل مع فريق BePrime — نحن هنا لمساعدتك في بناء منظومتك الاحترافية.",
};
    ...
    <div className="group relative rounded-2xl overflow-hidden transition-all duration-500 hover:scale-[1.02]">
      ...
      <div className="relative p-6 sm:p-7 flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className={`text-white/80 text-sm sm:text-base font-medium group-hover:text-white transition-colors ${dir === "ltr" ? "font-display" : ""}`} dir={dir || "rtl"}>
            {value}
          </p>
        </div>
      ...
      <main className="relative max-w-5xl mx-auto px-4 sm:px-8 pb-20">
        ...
        <div className="text-center mb-14 sm:mb-16 pt-4 sm:pt-8">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white mb-5 leading-tight">
            تواصل <span className="text-[#C6FF00]">معنا</span>
          </h1>
          <p className="text-white/35 text-sm sm:text-lg max-w-xl mx-auto leading-relaxed">
            أي سؤال، استفسار، أو محتاج مساعدة — إحنا هنا.
            <br className="hidden sm:block" />
            ردنا أسرع من القهوة ما تبرد ☕
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 max-w-3xl mx-auto mb-16">
          ...
          <ContactCard
            ...
            value="yousseef.ah@gmail.com"
            href="mailto:yousseef.ah@gmail.com"
            dir="ltr"
          />
          ...
          <ContactCard
            ...
            label="واتساب"
            value="01120920078"
            href="https://wa.me/201120920078?text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7%D9%8B!%20%D8%B9%D8%A7%D9%8A%D8%B2%20%D8%A3%D8%B3%D8%AA%D9%81%D8%B3%D8%B1%20%D8%B9%D9%86%20BePrime"
            dir="ltr"
          />
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="relative px-6 sm:px-12 py-10 sm:py-14">
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-3">
                جاهز تبدأ <span className="text-[#C6FF00]">منظومتك</span>؟
              </h2>
              <p className="text-white/30 text-sm sm:text-base mb-8 max-w-md mx-auto">
                كلمنا النهاردة ونسختك الجاهزة هتكون شغالة قبل ما تنام
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                {/* WhatsApp CTA */}
                <a
                  href="https://wa.me/201120920078?text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7%D9%8B!%20%D8%B9%D8%A7%D9%8A%D8%B2%20%D8%A3%D8%A8%D8%AF%D8%A3%20%D9%85%D8%B9%20BePrime"
                  target="_blank"
