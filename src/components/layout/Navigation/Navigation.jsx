  ...
  return (
    <section className="flex justify-between relative z-50">
      <nav className="flex items-center">
        <Link href="/">
          <div
            className={`h-8 lg:h-10 w-24 lg:w-[120px] ${isRTL ? "ml-8" : "mr-8"}`}
            style={{
              backgroundColor: 'var(--tw-accent-500, #C6FF00)',
              WebkitMaskImage: 'url(/beprime-logo.png)',
              WebkitMaskSize: 'contain',
              WebkitMaskRepeat: 'no-repeat',
              WebkitMaskPosition: isRTL ? 'right' : 'left',
              maskImage: 'url(/beprime-logo.png)',
              maskSize: 'contain',
              maskRepeat: 'no-repeat',
              maskPosition: isRTL ? 'right' : 'left',
            }}
            role="img"
