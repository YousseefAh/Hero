          ...
          <ul className="space-y-2">
            {sections.map((section, index) => {
              ...
              const indentClass = section.level > 1 
                ? 'pl-6 border-l-2 border-slate-200 dark:border-slate-700 ml-2' 
                : '';
                ...
                <li key={index} className={indentClass}>
                  <a
                    ...
                    className={`
                      ...
                      ${section.level === 1 
                        ? 'text-gray-900 dark:text-white font-bold text-base hover:bg-indigo-50 dark:hover:bg-indigo-900/20 hover:text-indigo-700 dark:hover:text-indigo-300' 
                        : 'text-gray-700 dark:text-gray-300 font-medium text-sm hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-gray-900 dark:hover:text-white'}
