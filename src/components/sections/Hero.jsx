    ...
    <section className="pt-24 md:pt-28 pb-8 md:pb-16">
      <div className="flex flex-nowrap justify-between md:gap-x-24 lg:gap-x-14">
        <div className="max-w-[50rem]">
          <h1 className="mb-16 sm:mb-4 font-bold text-3xl text-primary-500 sm:text-4xl md:text-5xl/[3.5rem] lg:text-6xl/[4rem] xl:text-7xl/[5rem] tracking-tight text-center">
            {title}{" "}
