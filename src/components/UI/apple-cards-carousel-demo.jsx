          ...
          >
            <p className="text-primary-500 text-base md:text-2xl font-sans max-w-3xl mx-auto">
              <span className="font-bold text-primary-500">
                Join thousands of creators sharing their expertise.
              </span>{" "}
              From fantasy sports analysis to creative workshops, our platform
              connects you with passionate experts ready to share their knowledge.
              Build your community, monetize your skills, and create meaningful
              connections.
            </p>
            <img
...
const data = [
  {
    ...
    title: "Master fantasy football analytics.",
    src: "https://images.unsplash.com/photo-1593508512255-86ab42a8e620?q=80&w=3556&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    content: <DummyContent />,
  },
  {
    category: "Video Creation",
    title: "Enhance your video content skills.",
    src: "https://images.unsplash.com/photo-1531554694128-c4c6665f59c2?q=80&w=3387&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    content: <DummyContent />,
  },
  {
    category: "Coaching",
    title: "Personal coaching sessions available.",
  ...
  },
  {
    ...
    title: "Learn music production from pros.",
