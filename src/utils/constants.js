...
const pricingCards = [
  ...
  },
  {
    ...
    tiers: [
      { clients: 150, price: "2,000" },
      { clients: 200, price: "3,000" },
      { clients: 250, price: "4,000" },
      { clients: 300, price: "5,000" },
      { clients: 400, price: "5,500" },
      { clients: 500, price: "6,000" },
      { clients: 1000, price: "7,000" },
    ],
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      "عدد عملاء غير محدود",
      "تطبيق موبايل كامل باسم براندك",
      "سيناريوهات أتمتة مبنية حسب شغلك",
      "تحكم كامل في إعدادات المنظومة",
      "نظام CRM وشات مدمج",
      "تدريب شامل لفريقك على النظام",
      "تطوير مميزات حصرية حسب طلبك",
