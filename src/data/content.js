...
export const content = {
  ...
  whyChooseYadora: {
    title: "لماذا تختار يادورا؟",
    description: "اختبر قوة بطاقات المحتوى التفاعلية التي تقربك من منشئي المحتوى المفضلين لديك.",
    cards: [
      {
        heading: "تواصل مع كبار منشئي المحتوى حول العالم",
        text: "مع أكثر من 300 منشئ محتوى موثق و 12.1 ألف مستخدم نشط، يادورا هي المنصة الأكثر ثقة لرؤى الرياضات الخيالية ومحتوى المبدعين.",
        imageAlt: "واجهة لوحة تحكم يادورا"
      },
      {
        heading: "واجهة لوحة تحكم يادورا",
        text: "رؤى متميزة في متناول يدك. احصل على تقارير خيالية حصرية، وجلسات تدريب، ووصول مباشر إلى منشئي المحتوى المفضلين لديك."
      },
      {
        heading: "ابدأ رحلتك الإبداعية اليوم مع منصة يادورا القوية",
        text: "انضم إلى آلاف المبدعين الذين بنوا مجتمعاتهم وحققوا الدخل من خبراتهم من خلال منصتنا المبتكرة.",
        imageAlt: "ميزات لوحة تحكم المنشئ"
      }
    ]
  },
